...
const ContentSecurityPolicy = `
  ...
  img-src 'self' blob: data: https://*.supabase.co https://*.supabase.in https://images.unsplash.com https://*.mediadelivery.net https://*.b-cdn.net https://picsum.photos https://*.picsum.photos;
