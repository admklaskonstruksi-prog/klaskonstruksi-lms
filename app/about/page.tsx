      ...
      <main className="max-w-6xl mx-auto py-20 px-6 space-y-24">
        ...
        <section className="max-w-4xl mx-auto space-y-10">
            <div className="text-center">
                <p className="text-[#F97316] font-bold tracking-widest uppercase text-sm mb-3">Ir. Arif Budianto — Founder, KLAS</p>
                <h1 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight">
                    a message from <span className="text-[#F97316]">founder</span>
                </h1>
            </div>
        ...
        <section className="relative bg-gray-900 rounded-[3rem] overflow-hidden text-white shadow-2xl">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 p-12 md:p-20 items-center">
                ...
                <p className="text-lg leading-relaxed text-gray-300 mt-6 border-l-4 border-[#F97316] pl-6">
        ...
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl hover:-translate-y-2 transition duration-300 group">
                    <div className="w-16 h-16 bg-orange-50 rounded-2xl flex items-center justify-center text-[#F97316] mb-6 group-hover:bg-[#F97316] group-hover:text-white transition-colors"><Layers size={32} /></div>
                ...
                <div className="bg-[#F97316] p-8 rounded-3xl shadow-xl hover:-translate-y-2 transition duration-300 text-white transform scale-105 z-10">
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl hover:-translate-y-2 transition duration-300 group">
                    <div className="w-16 h-16 bg-orange-50 rounded-2xl flex items-center justify-center text-[#F97316] mb-6 group-hover:bg-[#F97316] group-hover:text-white transition-colors"><CheckCircle size={32} /></div>
        ...
        <section className="bg-gray-50 rounded-[3rem] p-12 md:p-20 text-center">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-6">
                KLAS Learning Framework <span className="text-[#F97316]">=PILLAR</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
                ...
                <PillarCard number="02" title="Levels" desc="Elevates participants progressively from basics to mastery." color="bg-[#F97316]" />
