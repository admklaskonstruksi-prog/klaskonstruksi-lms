...
export default function LandingPage() {
  ...
  // 1. Ambil Data Kelas Terpopuler untuk Carousel
  useEffect(() => {
  ...
  // Fungsi scroll yang sudah disesuaikan
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#F97316] selection:text-white">
      ...
      {/* --- NAVBAR --- */}
      {/* Kita hilangkan fixed height (h-24) dan ganti dengan py-4 agar navbar melar mengikuti logo 160px secara otomatis */}
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            
            {/* Logo (Diperbesar 2x lipat menjadi 160px) */}
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/" className="text-[#F97316] font-bold transition-colors">
                Beranda
              </Link>
              <button onClick={() => scrollToSection("program")} className="text-gray-600 hover:text-[#F97316] font-medium transition-colors">
                Program Klas
              </button>
              <button onClick={() => scrollToSection("mentor")} className="text-gray-600 hover:text-[#F97316] font-medium transition-colors">
                Daftar Mentor
              </button>
            </div>
            ...
            <div className="hidden md:flex items-center gap-3">
              <Link 
                href="/login" 
                className="px-5 py-2.5 text-gray-600 font-bold hover:text-[#F97316] transition-colors"
              >
                Masuk
              </Link>
              <Link 
            ...
            <div className="md:hidden flex items-center">
              <button 
                ...
                className="text-gray-500 hover:text-[#F97316] focus:outline-none"
              >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 absolute w-full shadow-2xl">
            <div className="px-4 pt-2 pb-6 space-y-2">
              <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="block w-full text-left px-3 py-3 text-base font-bold text-[#F97316] bg-orange-50 rounded-lg">
                Beranda
              </Link>
              <button onClick={() => scrollToSection("program")} className="block w-full text-left px-3 py-3 text-base font-medium text-gray-700 hover:text-[#F97316] hover:bg-gray-50 rounded-lg">
                Program Klas
              </button>
              <button onClick={() => scrollToSection("mentor")} className="block w-full text-left px-3 py-3 text-base font-medium text-gray-700 hover:text-[#F97316] hover:bg-gray-50 rounded-lg">
                Daftar Mentor
              </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-2xl z-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-50 text-[#F97316] text-sm font-bold mb-6 border border-orange-100">
              ...
              <h1 className="text-4xl lg:text-6xl font-extrabold text-gray-900 leading-[1.15] mb-6 tracking-tight">
                Bangun Karir Impian di Dunia <span className="text-[#F97316]">Konstruksi</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button 
                  ...
                  className="px-8 py-4 bg-white text-gray-700 font-bold rounded-xl border-2 border-gray-200 hover:border-[#F97316] hover:text-[#F97316] transition-all flex items-center justify-center gap-2 text-lg"
                >
            ...
            <div className="relative lg:h-[550px] w-full flex items-center justify-center z-10">
               <div className="absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#F97316]/20 rounded-full blur-3xl -z-10"></div>
               ...
               <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white w-full max-w-md aspect-[4/5] transform lg:rotate-2 hover:rotate-0 transition-all duration-500">
                  ...
                  <div className="absolute bottom-6 -left-4 bg-white p-4 rounded-xl shadow-xl flex items-center gap-3 animate-bounce hidden sm:flex border border-gray-100">
                    <div className="w-10 h-10 bg-orange-100 text-[#F97316] rounded-full flex items-center justify-center">
                      <CheckCircle size={20} />
                    </div>
                    <div>
      ...
      <section id="program" className="py-20 bg-gray-50 border-y border-gray-100 overflow-hidden scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-8">
             ...
             <Link href="/login" className="hidden md:flex items-center gap-2 text-[#F97316] font-bold hover:text-[#EA580C]">
            ...
            {highlightCourses.length > 0 ? (
               highlightCourses.map((course) => (
                  <Link 
                     ...
                     key={course.id} 
                     className="min-w-[280px] sm:min-w-[320px] bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 snap-start flex flex-col group"
                  >
                     <div className="aspect-video relative bg-gray-100 border-b border-gray-100 overflow-hidden">
                        ...
                        <div className="absolute top-2 left-2 bg-[#eceb98] text-[#3d3c0a] text-[10px] font-bold px-2 py-1 rounded shadow-sm">
                           Terlaris
                        </div>
                     </div>

                     <div className="p-4 flex flex-col flex-1">
                        <h3 className="font-bold text-gray-900 leading-tight line-clamp-2 mb-1 group-hover:text-[#F97316] transition-colors">
                           {course.title}
                        </h3>
                        <p className="text-xs text-gray-500 mb-2">Klas Konstruksi</p>
                        
                        <div className="flex items-center gap-1 text-xs mb-3">
                           <span className="font-bold text-[#b4690e]">{course.rating || "4.8"}</span>
                        ...
                        <div className="mt-auto flex items-center gap-2 pt-3 border-t border-gray-100">
                           {course.price > 0 ? (
                              ...
                              <span className="font-bold text-[#F97316] text-lg">Gratis</span>
                           )}
                        </div>
                     </div>
                  </Link>
      ...
      {/* --- MENTOR SECTION (UBAH JADI AJAKAN BERGABUNG) --- */}
      <section id="mentor" className="py-24 bg-white border-b border-gray-100 scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="bg-orange-50/50 rounded-3xl p-8 md:p-14 lg:p-16 flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-20 border border-orange-100 relative overflow-hidden">
            
            {/* Dekorasi Background */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#F97316]/10 rounded-full blur-3xl -z-10 transform translate-x-1/2 -translate-y-1/2"></div>
            ...
            <div className="md:w-1/2 z-10">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
                ...
                <span className="text-[#F97316]">Jadilah Mentor Kami!</span>
              </h2>
              ...
              <ul className="space-y-4 mb-10">
                <li className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 text-[#F97316] flex items-center justify-center shrink-0">
                    <CheckCircle size={16} />
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-gray-100">
            {[
              ...
              <div key={idx} className="flex flex-col items-center">
                <stat.icon className="text-[#F97316] mb-4 w-8 h-8" />
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             <div className="p-8 rounded-2xl bg-white border border-gray-200 hover:border-[#F97316] hover:shadow-xl transition-all group">
                <div className="w-14 h-14 bg-orange-50 text-[#F97316] rounded-xl flex items-center justify-center mb-6 group-hover:bg-[#F97316] group-hover:text-white transition-colors">
                   <BookOpen size={28} />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><button onClick={() => scrollToSection("program")} className="hover:text-[#F97316] transition-colors">Program Klas</button></li>
              <li><button onClick={() => scrollToSection("mentor")} className="hover:text-[#F97316] transition-colors">Daftar Mentor</button></li>
            </ul>
          </div>
