...
export default function EbookPublishToggle({ ebookId, isPublished }: { ebookId: string, isPublished: boolean }) {
  ...
  const handleToggle = async () => {
    ...
    const { error } = await supabase.from('ebooks').update({ is_published: newValue }).eq('id', ebookId);
