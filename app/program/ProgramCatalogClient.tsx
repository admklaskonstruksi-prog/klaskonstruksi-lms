               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                 {displayedCourses.map((course) => {
                   ...
                   const CardBody = (
                     <>
                       <div className="relative w-full aspect-video bg-gray-100 border-b border-gray-100 overflow-hidden shrink-0">
                         ...
                         {isOwned && isPublished && (<div className="absolute inset-0 bg-black/30 flex items-center justify-center z-10"><span className="bg-white text-[#00C9A7] font-black px-4 py-2 rounded-lg text-sm flex items-center gap-1.5"><Tag size={14}/> DIMILIKI</span></div>)}
                       </div>
                       ...
                       <div className="p-5 flex flex-col flex-1">
                         ...
                         {isPublished ? (
                           <>
                             {/* TAMPILAN STATISTIK DAN HARGA JIKA KELAS PUBLISHED */}
                           ...
                           /* TAMPILAN COMING SOON JIKA KELAS DRAFT */
                           <div className="mt-auto pt-5 border-t border-gray-50 flex items-center justify-center">
                              <span className="text-[#F97316] bg-orange-50 border border-orange-100 px-4 py-1.5 rounded-full text-[11px] font-black tracking-widest uppercase">
                                Segera Hadir
                              </span>
                           </div>
                         )}
                   ...
                   return isPublished ? (
                     ...
                     <div key={course.id} className="flex flex-col bg-white rounded-2xl border border-gray-100 overflow-hidden relative opacity-80 cursor-not-allowed transition-all duration-300">
                       {CardBody}
                     </div>
                   );
                 })}
